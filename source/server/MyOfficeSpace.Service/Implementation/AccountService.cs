...
using MyOfficeSpace.Domain.Common;
using MyOfficeSpace.Domain.Enum;
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _emailService.SendEmailAsync(new MailRequest() { From = "MyOfficeSpace@gmail.com", ToEmail = user.Email, Body = $"Please confirm your account by visiting this URL {verificationUri}", Subject = "Confirm Registration" });
                    }
