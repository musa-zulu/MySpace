...
using MyOfficeSpace.Infrastructure.Mapping;
using MyOfficeSpace.Persistence;
using MyOfficeSpace.Service.Contract;
using MyOfficeSpace.Service.Implementation;
using System;
...
namespace MyOfficeSpace.Infrastructure.Extension
{
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
                   options.UseSqlServer(configuration.GetConnectionString("MyOfficeSpaceConn") ?? configRoot["ConnectionStrings:MyOfficeSpaceConn"]
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "My OfficeSpace WebAPI",
                        Version = "1",
                        Description = "Through this API you can access MyOfficeSpace details",
        ...
        public static void AddHealthCheck(this IServiceCollection serviceCollection, AppSettings appSettings, IConfiguration configuration)
        {
            serviceCollection.AddHealthChecks()
                ...
                .AddSqlServer(configuration.GetConnectionString("MyOfficeSpaceConn"));
